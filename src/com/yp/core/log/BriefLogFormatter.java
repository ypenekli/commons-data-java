...
public class BriefLogFormatter extends Formatter {
	...
	// OpenJDK made a questionable, backwards incompatible change to the Logger
	// implementation. It internally uses
	// weak references now which means simply fetching the logger and changing its
	// configuration won't work. We must
